 ...
 * datainside is only used by the thread and so will be thread safe
 *
 * $Author: B.Richards $
 ...
 *
 * This is a template for a Tool That employs mulitple threads. Please fill out the descripton and author
 * information.
 *
 * $Author: B.Richards $
 * $Date: 2019/05/28 10:44:00 $
